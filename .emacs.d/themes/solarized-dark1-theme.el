(deftheme solarized-dark1
  "Created 2017-10-07.")

(custom-theme-set-faces
 'solarized-dark1
 '(button ((t (:underline t))))
 '(cursor ((t (:background "#839496" :foreground "brightblack" :inverse-video t))))
 '(error ((((class color) (min-colors 89)) (:foreground "#cb4b16"))))
 '(escape-glyph ((((class color) (min-colors 89)) (:foreground "#6c71c4"))))
 '(fringe ((t (:background "brightblack" :foreground "#586e75"))))
 '(header-line ((((class color) (min-colors 89)) (:box (:line-width 2 :color "#002b36" :style unspecified) :background "black" :foreground "#839496" :overline nil :inverse-video unspecified))))
 '(highlight ((t (:background "brightwhite"))))
 ...
 '(menu ((t (:background "brightblack" :foreground "#839496"))))
 '(minibuffer-prompt ((((class color) (min-colors 89)) (:foreground "#839496"))))
 '(mode-line ((((class color) (min-colors 89)) (:inverse-video unspecified :overline "#073642" :underline "#284b54" :foreground "black" :background "brightwhite" :box (:line-width 1 :color "#073642" :style unspecified)))))
 '(mode-line-buffer-id ((((class color) (min-colors 89)) (:foreground "brightgreen" :weight bold))))
 '(mode-line-inactive ((((class color) (min-colors 89)) (:inverse-video unspecified :overline "#073642" :foreground "brightgreen" :background "black" :box (:line-width 1 :color "#002b36" :style unspecified)))))
 ...
 '(default ((t (:background "brightblack" :foreground "#839496")))))

(provide-theme 'solarized-dark1)
